    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: widget.hintStyle ?? TextFontStyle.text14c192A48400,
          ...
          enabledBorder: OutlineInputBorder(
            ...
            borderSide: widget.isBorder == true
                ? BorderSide(
                    color: widget.borderColor ?? AppColors.c000000, width: 1.w)
                : BorderSide.none,
          ),
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(widget.borderRadius),
            borderSide: BorderSide(
                color: widget.focusBorderColor ?? AppColors.c000000,
        ...
        style: widget.textInputStyle ?? TextFontStyle.text18allPrimaryColorw500,
      ),
    );
  }
}
