...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/Chat icon.png
  AssetGenImage get chatIcon => const AssetGenImage('assets/icons/Chat icon.png');
  ...
  /// File path: assets/icons/Danger2.png
  ...
  /// File path: assets/icons/Strat.png
  AssetGenImage get strat => const AssetGenImage('assets/icons/Strat.png');

  /// File path: assets/icons/address.png
  AssetGenImage get address => const AssetGenImage('assets/icons/address.png');

  /// File path: assets/icons/array.png
  AssetGenImage get array => const AssetGenImage('assets/icons/array.png');

  /// File path: assets/icons/array1.png
  ...
  AssetGenImage get bankOfAmerica => const AssetGenImage('assets/icons/bank-of-america.png');
  ...
  /// File path: assets/icons/chat2.png
  ...
  /// File path: assets/icons/clender.png
  ...
  /// File path: assets/icons/deleatsvg.svg
  String get deleatsvg => 'assets/icons/deleatsvg.svg';

  /// File path: assets/icons/eddit.png
  ...
  /// File path: assets/icons/eye_open.png
  ...
  /// File path: assets/icons/home2.png
  AssetGenImage get home2 => const AssetGenImage('assets/icons/home2.png');

  /// File path: assets/icons/icon (1).svg
  String get icon1 => 'assets/icons/icon (1).svg';

  /// File path: assets/icons/icon (2).svg
  String get icon2 => 'assets/icons/icon (2).svg';

  /// File path: assets/icons/icon (3).svg
  String get icon3 => 'assets/icons/icon (3).svg';

  /// File path: assets/icons/icon (4).svg
  String get icon4 => 'assets/icons/icon (4).svg';

  /// File path: assets/icons/icon (5).svg
  String get icon5 => 'assets/icons/icon (5).svg';
  ...
  /// File path: assets/icons/pick.svg
  String get pick => 'assets/icons/pick.svg';

  /// File path: assets/icons/plus.png
  AssetGenImage get plus => const AssetGenImage('assets/icons/plus.png');

  /// File path: assets/icons/plusiconincircle.svg
  String get plusiconincircle => 'assets/icons/plusiconincircle.svg';

  /// File path: assets/icons/preson2.png
  AssetGenImage get preson2 => const AssetGenImage('assets/icons/preson2.png');
  ...
  /// File path: assets/icons/varning.png
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [imageTwo, backgroud4, backgroud5, background, background1, chatScreenHeaderImage, emptyImg, imageFour, imageOne, imageThee, mastercardWithBackground, matchimg, paymentSuccess, paypalLogo, paypelWithBackground, profileAvatar, splashImage, visaWithBackground];
}

class $AssetsLottieGen {
  const $AssetsLottieGen();

  /// File path: assets/lottie/waiting_lottie.json
  String get waitingLottie => 'assets/lottie/waiting_lottie.json';

  /// List of all assets
  List<String> get values => [waitingLottie];
}
