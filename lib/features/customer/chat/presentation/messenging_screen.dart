...
class MessengingScreen extends StatefulWidget {
  ...
  @override
  MessengingScreenState createState() => MessengingScreenState();
}

class MessengingScreenState extends State<MessengingScreen> {
              ...
              child: Row(
                children: [
                  Expanded(
                    ...
                    textInputStyle: const TextStyle(overflow: TextOverflow.ellipsis),
                    height: 45,
                    borderRadius: 30.r,
                    isPrefixIcon: false,
                    suffixIcon: Padding(
