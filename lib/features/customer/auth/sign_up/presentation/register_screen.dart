    ...
    try {
      ...
      await customerSignUpRxObj
        ...
        passwordConfirmation: conformPasswordController.text,
          ...
          .then((value) {
        setState(() {
          _isLoading = false; // Hide loading after API response
        });
        ...
        if (value) {
          ...
          ToastUtil.showShortToast("Failed to varify Account");
        }
      });
    } catch (e) {
      // 6. Handle any exceptions and hide loading
      setState(() {
        _isLoading = false; // Ensure loading is hidden if an error occurs
      });
      ...
      body: Form(
        ...
        child: Padding(
          ...
          child: Stack(children: [
            ...
            // Loading Indicator
            if (_isLoading) // if loading is  true
