class EngineerSignupOtpVerifyModel {
  Data? data;
  String? message;
  int? status;

  EngineerSignupOtpVerifyModel({this.data, this.message, this.status});

  EngineerSignupOtpVerifyModel.fromJson(Map<String, dynamic> json) {
