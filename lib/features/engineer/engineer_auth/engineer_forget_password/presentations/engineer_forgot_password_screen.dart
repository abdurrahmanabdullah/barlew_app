...
class EngineerForgotPasswordScreen extends StatefulWidget {
  const EngineerForgotPasswordScreen({super.key});

  @override
  State<EngineerForgotPasswordScreen> createState() =>
      _EngineerForgotPasswordScreenState();
}

class _EngineerForgotPasswordScreenState
    extends State<EngineerForgotPasswordScreen> {
  ...
  Future<void> submitForm({required String email}) async {
    try {
      if (_formKey.currentState!.validate()) {
        ...
        await forgetPasswordSendOTPRxObj
