...
import 'dart:developer';
import 'dart:io';
import 'package:barlew_app/common_widget/custome_dropdown.dart';
import 'package:barlew_app/helpers/toast.dart';
import 'package:barlew_app/networks/api_access.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
...
////skill api call call ---------------------
  ...
  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<DataEntryProvider>(context);
    return Scaffold(
      backgroundColor: AppColors.cFFFFFF,
      body: StreamBuilder(
          stream: engineerProfileRXObj.dataFetcher,
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          UIHelper.verticalSpace(11.h),
                          // MyCustomDropdown(
                          //   dropdownfillColor: AppColors.cFFFFFF,
                          //   borderColor: AppColors.cFFFFFF,
                          //   textStyle: TextFontStyle.text18allPrimaryColorw500
                          ...
                          //   verticPadding: 6.h,
                          //   borderRadius: 4.r,
                          //   selectedValue: selectedSkills.isEmpty
                          //       ? null
                          //       : selectedSkills.first[
                          //           'name'], // Just pass one selected skill name
                          //   dropDownValue: skillOptions.keys
                          //       .toList(), // Pass the skill names for dropdown options
                          //   onTap: (newSkill) {
                          //     setState(() {
                          //       if (selectedSkills
                          //           .any((s) => s['name'] == newSkill)) {
                          //         selectedSkills.removeWhere(
                          //             (s) => s['name'] == newSkill);
                          //       } else {
                          //         selectedSkills.add({
                          //           "id": skillOptions[newSkill],
                          //           "name": newSkill,
                          //         });
                          //       }
                          //     });
