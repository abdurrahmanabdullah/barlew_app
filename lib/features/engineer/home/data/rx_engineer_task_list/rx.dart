...
import 'package:barlew_app/features/engineer/home/data/rx_engineer_task_list/api.dart';
...
final class EngineerTaskListRX
    extends RxResponseInt<EngineerTaskResponseModel> {
  final api = EngineerTaskListApi.instance;

  EngineerTaskListRX({required super.empty, required super.dataFetcher});
